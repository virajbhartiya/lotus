...
var EmbeddedBuiltinActorsMetadata []*BuiltinActorsMetadata = []*BuiltinActorsMetadata{{
	...
	Network:      "butterflynet",
	Version:      13,
	BundleGitTag: "v13.0.0-drand-test",
	ManifestCid:  MustParseCid("bafy2bzacec4rkyiy7oiii6p5smrathk34qutxs4fkxwfygheeyn6d5ldael3a"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacealqf44d6m6jkrb4dryux6cjb7m2gsely7rqptq6mbgpqjaf2btp4"),
		"cron":             MustParseCid("bafk2bzacedjejyk456xvjft67kj3kwkgvb54zozg7hangujyijq7n53bffwac"),
		"datacap":          MustParseCid("bafk2bzaceb4g4konbgnlcamsus7iweekjmtfblxaqu4fbpm5kza3qmnbjb5b4"),
		"eam":              MustParseCid("bafk2bzacearf7mns7by7bzu6qeunj6akq5xjl4jvsfn3v7hzozi5dsvwcxeyo"),
		"ethaccount":       MustParseCid("bafk2bzacedc4morngjpgksxc62i33tom43idihba2z2boqsjhjmmkrqaktshs"),
		"evm":              MustParseCid("bafk2bzacebot542d7plxiysqq2r5lktn6ilxup7lpldimvf4rxlsxyuuspjxe"),
		"init":             MustParseCid("bafk2bzacear44fgfhkbegoc54svf56wswolctd6rcdg5dto6prjzldormfchk"),
		"multisig":         MustParseCid("bafk2bzaceatk7p36wvkk37tqm2pk3tefa2bwtltumkkwvsvzvx4em6nxzictg"),
		"paymentchannel":   MustParseCid("bafk2bzacectqsf5qny5uf6znx2wng5uauohmqvcibykz5ytmlpcjxabfmtvzm"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzacedefmeiigvpa2qiuvcnh25hk6bozcfagijbifzl3liuhgkcn2rdpe"),
		"storagemarket":    MustParseCid("bafk2bzacedlrmix47wl2k66fa2qowxplnk6oqaizsmrwkxbds7sw5avya35bo"),
		"storageminer":     MustParseCid("bafk2bzaceb4vnkcatreye235lqlgmveanfyzsfrqxe75lgrnntbguoxirw6n4"),
		"storagepower":     MustParseCid("bafk2bzacectcrntyhegvfmw4mkojg23gzu7w4nkushbm6sditjroyyuh4p6vo"),
		"system":           MustParseCid("bafk2bzacecebhdfzs7rgcg2k6p2a4p37abnvdmye77hbcn5yevuq3zdy7zeds"),
		"verifiedregistry": MustParseCid("bafk2bzacebco4elxhpgj3tnzgogkwyylop63gigsai2lxf4hl6nhvurg6tkno"),
	},
}, {
	...
	Version:      13,
	BundleGitTag: "v13.0.0-drand-test",
	ManifestCid:  MustParseCid("bafy2bzacechwk4uot3spfbikzaru7bt2sho3mv4vjyu5smiofu3k6lw2f3s54"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacebwk5w3qc7ixucpmawrcxkz2qemb3gksi7hkkm4hkq4ilxalnjasi"),
		"cron":             MustParseCid("bafk2bzaceaf3ere5n5j53pmyeg3rlxbgjcpce6rdir3clguffztfx7ag7fkya"),
		"datacap":          MustParseCid("bafk2bzacedxoqvx4orlr3nkgczeu7ahoxt64nz32g6khkdxsmhpaykhatpjfk"),
		"eam":              MustParseCid("bafk2bzaceb7qgpj2x5wkkw3qwtsldhbsbjp4barmc77k5npdwzoathg7z7xdm"),
		"ethaccount":       MustParseCid("bafk2bzacecsptxz4emn7watpoa5ytbwrwktscja2b7wyjg7w5nqqr2shi246a"),
		"evm":              MustParseCid("bafk2bzaceaaj62bl3zlxaafsq6iag6aonnzlbddy2k6hvimfhuuaiv4t4ukv2"),
		"init":             MustParseCid("bafk2bzacedy4ya4az7ca45yhbgr6iqrqinmszvoctlngxspepdomxrpsrirn2"),
		"multisig":         MustParseCid("bafk2bzacedrtrugzlditxdpyrypqtxonx3ce4657gu24wubh7v6fgkwiqmozw"),
		"paymentchannel":   MustParseCid("bafk2bzacecot6qv5lwycgcmq3n6opcxt36mjodcmigp3zorw2qd5gwhpjp534"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzacebdymcsb6haelzmmpeiiyol7m3twqkcbn57hb7uai7arwiqt6djoe"),
		"storagemarket":    MustParseCid("bafk2bzaceadzao6znsto32ajta6rdjyv6mdk52w6ykiw6l4vvigmrr55b67eo"),
		"storageminer":     MustParseCid("bafk2bzacecql7hvadrwust4h62vri4f5rxfuq7ws3nhj2s3u2iartacvy54gq"),
		"storagepower":     MustParseCid("bafk2bzaceaugp5ieb4hlzqoco4ivfxidodl3i2gjkadhzzhhhzfi3kn4byrtq"),
		"system":           MustParseCid("bafk2bzacebs6tojopcehfmfen6fuopuqeplxhsge7gcf45nwlz23ynldtxpuu"),
		"verifiedregistry": MustParseCid("bafk2bzaceb7kynkbjja4eogmdmq4ourljxvmye33t22nvagkl56a7x62fspbg"),
	},
}, {
	...
	Version:      13,
	BundleGitTag: "v13.0.0-drand-test",
	ManifestCid:  MustParseCid("bafy2bzacebh7nlxlovo4hvnna5l4n5ykeyjmhvw262jsbrxamfvupdly7pgoq"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacecfgjckek6eqk6o26yycsjyfffcdbfjhyo3bzq6oa552ph3i4foba"),
		"cron":             MustParseCid("bafk2bzacec6bd7bd55dqtve3lvwsoop36wase6yll56t7u4rkwehofjtjq5xi"),
		"datacap":          MustParseCid("bafk2bzacecri3oikb56zp6yqtyfdgpq3uzd6nndgatnehniivfwwvwmeivopq"),
		"eam":              MustParseCid("bafk2bzaceau7xoc46tkhedvuwtlzdptac3xwirb7prbxeaplegsqalzxlxpym"),
		"ethaccount":       MustParseCid("bafk2bzacebxxdc4jmud7mphbclxu757evg4b6rlzqhdlluaotw4ajvsq425hq"),
		"evm":              MustParseCid("bafk2bzacebhso4uiimyrspv4cn4rwt5v5do5ybkyxdfhgfg24572hazvhdqvk"),
		"init":             MustParseCid("bafk2bzaceajtzbowjnxnused5pcjtsw62msvan7inlssybmrbmgqbagvtgl3a"),
		"multisig":         MustParseCid("bafk2bzaceaxqvvlij5momykkj5empoois5pq4zjlpf2wmcpwp5don25nsanko"),
		"paymentchannel":   MustParseCid("bafk2bzacecrfl4yohqaprplbfbff6wistha4eyphmwdx2iq37oy7ada2ihj4q"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzaceaqxu7asnytau5tyrvtwhbjl22ktkfvv5lmf72gs4x2fanpie2ipm"),
		"storagemarket":    MustParseCid("bafk2bzacebgmp7uem6pzztinhg3m5bgq7usatc67yvlgxcyqohz3glaue7atm"),
		"storageminer":     MustParseCid("bafk2bzacedpjxvnhi3chjnq5gkcnavavf2mx4kyroyci6mqtq3viao4itlaia"),
		"storagepower":     MustParseCid("bafk2bzacedaiikw6p4gpugsrrwg3aeamlwmuudlqtr6qplv4grmdqzhkw3hpm"),
		"system":           MustParseCid("bafk2bzacecxk6jbbknqjbksfzvp5zvv3yjqo6vprmuqvdfi2ni7pn26qsek2i"),
		"verifiedregistry": MustParseCid("bafk2bzacedmct7kohclsr6dz4m62qjchau3czgjoxt5ehko3loid5pcsacmc4"),
	},
}, {
	Network: "devnet",
	Version: 8,
	...
	Version:      13,
	BundleGitTag: "v13.0.0-drand-test",
	ManifestCid:  MustParseCid("bafy2bzacec7m4klgyekusdfdfluyzudr247vquxayubhnddv3obexvpeg3jba"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzaced2engaiagpwla2r6p5wquexghpib5cf2s53sxz3xcqjucafgixja"),
		"cron":             MustParseCid("bafk2bzacedfij7gfjz6j6hnvaqybs77ewutomhl7h2raginzrlc7mrqdf6pnm"),
		"datacap":          MustParseCid("bafk2bzaced5oelsf5bkp2ikvgwarkjzizcfzdu3jwbg6ic5nnvzghbzaambrw"),
		"eam":              MustParseCid("bafk2bzaceatbsill6pmxshc225po6s2ngs5u4tkgm4ki4jdj37hl72r3mk2bc"),
		"ethaccount":       MustParseCid("bafk2bzaceanlru3ecdpqybat5psd6bbpcukptr7komxfeyutgmnvzygqwiycu"),
		"evm":              MustParseCid("bafk2bzacedoy4ttw4lc7rtsl4vdrs6vn6tq2wnsqek6skcs2us7y4utwtdyh4"),
		"init":             MustParseCid("bafk2bzacedbwosqzd2jxs3yzuxx2seuths65cks4mpvktyhwr3ckrwujlgizm"),
		"multisig":         MustParseCid("bafk2bzacedklvmiq2qhiufl3wukf57ev3ykyos36dv33caabpklaxrjqonluy"),
		"paymentchannel":   MustParseCid("bafk2bzacecjnouplmgibvs6zfqw2w3yyt3wt2yffkpggtsgatsqtcfpxokvs4"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzacebc444qbulq5qw7szhm2ggihonwt45qqgmpsk3ijrqslg4nmgxqoo"),
		"storagemarket":    MustParseCid("bafk2bzacebkizyop5bo7uyqsjzr6nzbg5o2lb57wzek7nba4isbutocgyn5ms"),
		"storageminer":     MustParseCid("bafk2bzaceavh3wgj76sjsraitufsizbsemyg5cm3zww72sffvqojmazxg6no4"),
		"storagepower":     MustParseCid("bafk2bzaced5ycbswwqwzvsoi7setzcf4evp5tbur77qzowydujple2i73nuja"),
		"system":           MustParseCid("bafk2bzacedborbvu6uyxtwvychvziodj6qhcd6bd45iscz7ss5k6zfovurtys"),
		"verifiedregistry": MustParseCid("bafk2bzacec66sciwrl25hscnbjmwsofom4qwp4a4zpv3skub4l4xbpkv4oxto"),
	},
}, {
	Network: "hyperspace",
	Version: 8,
	...
	Version:      13,
	BundleGitTag: "v13.0.0-drand-test",
	ManifestCid:  MustParseCid("bafy2bzacebm3v7xi4sxb7cea4gqypackmis3kwypdjzxyqsfu2cg2evgtyr34"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacectd4jczrlr2eykzoispwwwr4cocnrmgapw42jkykbcwukged5qty"),
		"cron":             MustParseCid("bafk2bzacealwjt6ydl7guq7bcsvdk4lmx2n2hehryvgpq4ankis5dlah35ysy"),
		"datacap":          MustParseCid("bafk2bzacedck5ce4pgmvwm6asshq4eq53u33hyuh22fdteqsfb3kikbbzlox6"),
		"eam":              MustParseCid("bafk2bzacebfqklm6vwr5p7byke6s7wwqt7l2bauwep7hl475crfwex4xdwh2y"),
		"ethaccount":       MustParseCid("bafk2bzaceajkmznxdhbzh6b6u4rpoocjrc3rnrsyzefz7lp7cmoxvgcsjb6wk"),
		"evm":              MustParseCid("bafk2bzacecnxuor2i3l4hdurethkiwogolwmcym7lnna3blntf7rtbs2hsl26"),
		"init":             MustParseCid("bafk2bzacea6fsmctuvwyggerr57blrgbon5lobwbvi5bkmszj2ikxdq76xlvo"),
		"multisig":         MustParseCid("bafk2bzaceblr3tr6mig62vprjfk5zntckke2jk7qse5bhnixxjtdfyj353njc"),
		"paymentchannel":   MustParseCid("bafk2bzacea7kazoojzutcslq6appih34qnis477ux5fsstq4mxaefatapwtc6"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzacedvc3746z5rwxbrkywsiw6py6wc4rrjt6wtnga45ps6thldifyk2y"),
		"storagemarket":    MustParseCid("bafk2bzacec7fxc5odxrrldl2sxq72huhsytfxooqh7raiawpwyzvm34xrbu5e"),
		"storageminer":     MustParseCid("bafk2bzacedhekcqflqt3f3b7gfvtqbvk6s245vg5gc7hzcjgvzlrtck5zy2ca"),
		"storagepower":     MustParseCid("bafk2bzacedyrmbvnjgx2bvd6ovu5c4kziwahtqycmcflxjnvfb4lzfrfkbghc"),
		"system":           MustParseCid("bafk2bzacedteyscb7zkkra4qyh6oimzoy3hwrpiljcu72pros5p2qpu5rzeye"),
		"verifiedregistry": MustParseCid("bafk2bzacedrhp24aqiunmzuf5vlbtq5dyuz66t3g43aa2jmnfrnh5hkdleju4"),
	},
}, {
	Network: "testing",
	Version: 8,
	...
	Version:      13,
	BundleGitTag: "v13.0.0-drand-test",
	ManifestCid:  MustParseCid("bafy2bzacebrm45w6qvkky7e7tch3bqomz4nyxig4vt3o6ufcxiti7f2tu3nqg"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacebdu4efgainqmf5pokupwoqgpyhst4yvw6ntrpe6itbqgwsn3r2xs"),
		"cron":             MustParseCid("bafk2bzacecpgoscrxtsbt5glp6vob6z5abwjxq6zkh7lxdhwzomanf3ln4nrm"),
		"datacap":          MustParseCid("bafk2bzacecwvzrscxs6jv5ftvsjtzmcq5662p6m4dt3r67ewmugxetuku2kok"),
		"eam":              MustParseCid("bafk2bzacea5w6xymwc3aopakyemquusosmnx4j7nhem2hplrq67e6a2u56rom"),
		"ethaccount":       MustParseCid("bafk2bzacecobou54sesvtinu5bsmgfqnile53nwddz2kn4kczeviyt2bs4y64"),
		"evm":              MustParseCid("bafk2bzacea6mb423slnp46gzdfxc2br5lelvi7dnbaopichmpziaab6tvl5xe"),
		"init":             MustParseCid("bafk2bzaceaei7pkyvv5kqvh2kk6hu5n3jd6t4xcyga23x3dmnn7znnvbfbm6s"),
		"multisig":         MustParseCid("bafk2bzacebbepgtshvpxsuskzsveu6hgedneexk42zcpaauiwiiksx64ipyye"),
		"paymentchannel":   MustParseCid("bafk2bzaced43t5eydvwfdagmbk2clgkimw66bjwwzjkpx434p3j3pcwb7wigu"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzacecgdq7jrtkbkl4eq24gfmwpworapnxj722fsrawvve7zjpxr5cfck"),
		"storagemarket":    MustParseCid("bafk2bzaceappsvumwu5ppp4qqyc2y3ofpuody4msj4cusfeauft6saciglkl2"),
		"storageminer":     MustParseCid("bafk2bzaceanliyjriwkfgtmoytwcxbnmk4362e3bt67pxgh7kp6ykb4q5fbvu"),
		"storagepower":     MustParseCid("bafk2bzacecwi4cbbohblftym5iglr4o4dj5golrgjl6bu26gr25aghoxpjad6"),
		"system":           MustParseCid("bafk2bzacebqv5ervpcs74zaqsn2xk5knt2lgx7gob5bll3geid4x32urssp6y"),
		"verifiedregistry": MustParseCid("bafk2bzacebgcntbtrzzewvuwib7fqv35zack3gwx7zp5b5jfrokebj4hq7gh6"),
	},
}, {
	...
	Version:      13,
	BundleGitTag: "v13.0.0-drand-test",
	ManifestCid:  MustParseCid("bafy2bzaceb4xh6qfup7ow3ardrms7a235qfegudzbj3vrrab2zdtzglwuvsek"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacebdu4efgainqmf5pokupwoqgpyhst4yvw6ntrpe6itbqgwsn3r2xs"),
		"cron":             MustParseCid("bafk2bzacecpgoscrxtsbt5glp6vob6z5abwjxq6zkh7lxdhwzomanf3ln4nrm"),
		"datacap":          MustParseCid("bafk2bzacecwvzrscxs6jv5ftvsjtzmcq5662p6m4dt3r67ewmugxetuku2kok"),
		...
		"evm":              MustParseCid("bafk2bzacea6mb423slnp46gzdfxc2br5lelvi7dnbaopichmpziaab6tvl5xe"),
		"init":             MustParseCid("bafk2bzaceaei7pkyvv5kqvh2kk6hu5n3jd6t4xcyga23x3dmnn7znnvbfbm6s"),
		"multisig":         MustParseCid("bafk2bzacea7mbsidbpry5vtowpumxuygoacghdzkqhp36zxyxilafwm32rpda"),
		"paymentchannel":   MustParseCid("bafk2bzaced43t5eydvwfdagmbk2clgkimw66bjwwzjkpx434p3j3pcwb7wigu"),
		"placeholder":      MustParseCid("bafk2bzacedfvut2myeleyq67fljcrw4kkmn5pb5dpyozovj7jpoez5irnc3ro"),
		"reward":           MustParseCid("bafk2bzacecgdq7jrtkbkl4eq24gfmwpworapnxj722fsrawvve7zjpxr5cfck"),
		"storagemarket":    MustParseCid("bafk2bzaceappsvumwu5ppp4qqyc2y3ofpuody4msj4cusfeauft6saciglkl2"),
		"storageminer":     MustParseCid("bafk2bzacebslkcrr3ttswzwt7niexxphim43lxwbjaeaeh5cl3o53xawupfl6"),
		"storagepower":     MustParseCid("bafk2bzacebc2qs6txynes4jhc26cpntsbtb42msxo4eohd5qnjw6yq7dqg2nm"),
		"system":           MustParseCid("bafk2bzacebqv5ervpcs74zaqsn2xk5knt2lgx7gob5bll3geid4x32urssp6y"),
		"verifiedregistry": MustParseCid("bafk2bzacebgcntbtrzzewvuwib7fqv35zack3gwx7zp5b5jfrokebj4hq7gh6"),
	},
}}
