...
require (
	...
	github.com/filecoin-project/go-state-types v0.12.1-0.20230831030229-0c8a77a2cad2
...
replace github.com/filecoin-project/go-state-types => /home/mikers/dev/filecoin-project/go-state-types
